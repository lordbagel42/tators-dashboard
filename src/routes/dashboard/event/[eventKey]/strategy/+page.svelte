...
<div class="container">
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <MatchSelect matches={matches.filter(m => teamsFromMatch(m.tba).includes(2122))} onSelect={selectFromMatch} message="Select teams from a match" />
        </div>
        <div class="col-md-6 d-flex align-items-end">
            <h4>
                ...
                class:text-secondary={alliance === 'unknown'}
            >{capitalize(alliance)}</span>
            </h4>
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-md-6">
            <label for="partners" class="mb-2">
                Partners
            </label>
            <div class="d-flex">
                <TeamSelect {teams} bind:selected={partner1} message="Select a partner" onSelect={selectFromTeams} />
                <TeamSelect {teams} bind:selected={partner2} message="Select a partner" onSelect={selectFromTeams} />
                <TeamSelect {teams} bind:selected={partner3} message="Select a partner" onSelect={selectFromTeams} />
            </div>
        </div>
        <div class="col-md-6">
            <label for="opponents" class="mb-2">
                Opponents
            </label>
            <div class="d-flex">
                <TeamSelect {teams} bind:selected={opponent1} message="Select an opponent" onSelect={selectFromTeams} />
                <TeamSelect {teams} bind:selected={opponent2} message="Select an opponent" onSelect={selectFromTeams} />
                <TeamSelect {teams} bind:selected={opponent3} message="Select an opponent" onSelect={selectFromTeams} />
            </div>
        </div>
    </div>
    <div class="row mb-3">
