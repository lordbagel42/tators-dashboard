...
{#snippet startingPos(data: Strategy.PartnerData)}
    ...
    <input value={data.data.startingPosition} type="text" id="starting-pos-{data.data.id}" class="form-control" onchange={(e) => {
        data.update(d => ({
            ...d,
...
{#snippet auto(data: Strategy.PartnerData)}
    ...
    <input value={data.data.auto} type="text" id="auto-{data.data.id}" class="form-control" onchange={(e) => {
        data.update(d => ({
            ...d,
...
{#snippet postAuto(data: Strategy.PartnerData | Strategy.OpponentData)}
    ...
    <textarea id="post-auto-{data.data.id}" class="form-control" onchange={(e) => {
        data.update(d => ({
            ...d,
            postAuto: e.currentTarget.value,
        }));
    }}
        placeholder="Immediately after Auto..."
    >{data.data.postAuto}</textarea>
{/snippet}

{#snippet role(data: Strategy.PartnerData | Strategy.OpponentData)}
    <label for="role-{data.data.id}" class="form-label">Role</label>
    <textarea id="role-{data.data.id}" class="form-control" onchange={(e) => {
        data.update(d => ({
            ...d,
    ...
    >{data.data.role}</textarea>
{/snippet}

{#snippet endgame(data: Strategy.PartnerData)}
    <label for="endgame-{data.data.id}" class="form-label">Endgame</label>
    <input value={data.data.endgame} type="text" id="endgame-{data.data.id}" class="form-control" onchange={(e) => {
        data.update(d => ({
            ...d,
...
{#snippet notes(data: Strategy.PartnerData | Strategy.OpponentData)}
    ...
    <textarea id="notes-{data.data.id}" class="form-control" onchange={(e) => {
        data.update(d => ({
            ...d,
