...
<div class="container">
    ...
    <div class="row">
        <div class="col">
            <div class="d-flex">
                <input id="event-key-input" type="text" class="form-control" bind:value={eventKey} placeholder="Event Key" />
                <button id="get-data" class="btn btn-primary" onclick={async () => getEvent()}>Get Data</button>
            </div>
        </div>
    </div>
    {#if event}
