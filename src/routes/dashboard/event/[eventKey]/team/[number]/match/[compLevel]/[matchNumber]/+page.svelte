	...
	<div class="row mb-3">
		<div class="col-12">
			...
			<div class="btn-group" role="group">
                {#if prev}
                    <a href="/dashboard/event/{event.tba.key}/team/{team.tba.team_number}/match/{prev.tba.comp_level}/{prev.tba.match_number}" class="btn btn-secondary me-2">
				...
				>
                {#if next}
                    <a href="/dashboard/event/{event.tba.key}/team/{team.tba.team_number}/match/{next.tba.comp_level}/{next.tba.match_number}" class="btn btn-secondary me-2">
                        Next
                        <i class="material-icons">
                            arrow_forward
                        </i>
